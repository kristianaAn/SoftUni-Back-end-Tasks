...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findAllInPriceRange(double lower, double higher) {
        return bookRepository.findAllByPriceLessThanOrPriceGreaterThan(BigDecimal.valueOf(lower), BigDecimal.valueOf(higher));
    }

    @Override
    public List<Book> findAllByReleaseDateYearIsNot(LocalDate localDate) {
        return bookRepository.findAllByReleaseDateIsNotLike(localDate);
    }
    ...
    @Override
    public List<Book> findAllByTitleLikeIgnoreCase(String string) {
    ...
    @Override
    public List<Book> findAllByTitleLengthGreaterThan(int length) {
    ...
    @Override
    public List<BookPrintInformation> findAllByTitle(String title) {
        List<BookPrintInformation> allByTitle = bookRepository.findAllByTitle(title);
